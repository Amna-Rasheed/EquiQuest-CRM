    ...
    <body>
        <div class="container">
            <div class="row justify-content-center">
                ...
                <div class="col-md-12" style="margin-bottom: 20px;">
                    <div class="card md-2">
                        <div class="card-header">{{ __('Upcoming Check Ups') }}</div>
                        <div class="card-body">
                            @if (session('status'))
                                <div class="alert alert-success" role="alert">
                                    {{ session('status') }}
                            ...
                            <div class="daily">
                                <div class="text-box">
                                    <h2><i class="fa fa-calendar mr-1"></i> Monthly vaccine (Henry)
                                    </h2>
                                    <p>13/02</p>
                                </div>
                                <div class="text-box">
                                    <h2><i class="fa fa-calendar mr-1"></i> General Check Up
                                        (Valentina)</h2>
                                    <p>24/02</p>
                                </div>
                            </div>
                ...
                <div class="col-md-12" style="margin-bottom: 20px;">
                    <div class="card md-2">
                        <div class="card-header">{{ __('Horse Rotation (Daily)') }}</div>
                        <div class="card-body">
                            @if (session('status'))
                                <div class="alert alert-success" role="alert">
                                    {{ session('status') }}
